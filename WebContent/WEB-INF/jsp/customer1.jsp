...
<form:form action="customer.do" method="POST" commandName="customer">
 <table>
  <tr>
    ...
    <td><form:errors path="customerId" cssClass="formError"/></td>
  </tr>
  <tr>
    <td>Customer Name</td>
  ...
  <tr>
    ...
    <td><form:errors path="product" cssClass="formError"/></td>
  </tr>
  <tr>
    <td>Mail Id</td>
    <td><form:input path="mailID"/></td>
    <td><form:errors path="mailID" cssClass="formError"/></td>
  </tr>
  <tr>
    <td>Address</td>
    <td><form:input path="address"/></td>
    <td><form:errors path="address" cssClass="formError"/></td>
  </tr>
  <tr>
    <td>Phone Number</td>
    <td><form:input path="phoneNumber"/></td>
    <td><form:errors path="phoneNumber" cssClass="formError"/></td>
  </tr>
  <tr>
    <td colspan="2">
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
